/* Original GridAnimation from Tomotoes/HomePage (adapted for unified site) */
'use strict';
...
window.visibilityChangeEvent = (window.hiddenProperty || 'hidden').replace(/hidden/i, 'visibilitychange');
