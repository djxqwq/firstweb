...
/** 完整图标技术栈：语言 + 原模板图标 + 个人栈 */
export const SKILL_GROUPS: { title: string; skills: SkillIcon[] }[] = [
  {
    title: "语言 · 核心",
    skills: [
      { skill_name: "C / C++", image: "cpp.svg", width: 64, height: 64 },
      { skill_name: "Python", image: "python.svg", width: 64, height: 64 },
      { skill_name: "Java", image: "java.svg", width: 64, height: 64 },
      { skill_name: "JavaScript", image: "js.png", width: 58, height: 58 },
      { skill_name: "TypeScript", image: "ts.png", width: 72, height: 72 },
      { skill_name: "算法竞赛", image: "algo.svg", width: 64, height: 64 },
      { skill_name: "Go", image: "go.png", width: 56, height: 56 },
    ],
  },
  {
    title: "前端",
    skills: [
      { skill_name: "HTML", image: "html.png", width: 72, height: 72 },
      { skill_name: "CSS", image: "css.png", width: 72, height: 72 },
      { skill_name: "Vue / Uniapp", image: "vue.svg", width: 64, height: 64 },
      { skill_name: "Uniapp", image: "uniapp.svg", width: 64, height: 64 },
      { skill_name: "React", image: "react.png", width: 72, height: 72 },
      { skill_name: "Next.js", image: "next.png", width: 72, height: 72 },
      { skill_name: "Tailwind", image: "tailwind.png", width: 72, height: 72 },
      { skill_name: "Framer", image: "framer.png", width: 72, height: 72 },
      { skill_name: "Redux", image: "redux.png", width: 64, height: 64 },
    ],
  },
  {
    title: "后端 · 数据",
    skills: [
      { skill_name: "Spring Boot", image: "spring.svg", width: 64, height: 64 },
      { skill_name: "FastAPI", image: "fastapi.svg", width: 64, height: 64 },
      { skill_name: "Node.js", image: "node.png", width: 72, height: 72 },
      { skill_name: "Express", image: "express.png", width: 72, height: 72 },
      { skill_name: "MySQL", image: "mysql.png", width: 64, height: 64 },
      { skill_name: "TiDB", image: "tidb.svg", width: 64, height: 64 },
      { skill_name: "PostgreSQL", image: "postgresql.png", width: 64, height: 64 },
      { skill_name: "MongoDB", image: "mongodb.png", width: 40, height: 40 },
      { skill_name: "Prisma", image: "prisma.png", width: 64, height: 64 },
      { skill_name: "GraphQL", image: "graphql.png", width: 72, height: 72 },
      { skill_name: "Firebase", image: "firebase.png", width: 52, height: 52 },
    ],
  },
  {
    title: "工程 · 视觉 · 其他",
    skills: [
      ...
      { skill_name: "Docker", image: "docker.png", width: 64, height: 64 },
      { skill_name: "React Native", image: "reactnative.png", width: 64, height: 64 },
      { skill_name: "Tauri", image: "tauri.png", width: 64, height: 64 },
      { skill_name: "Figma", image: "figma.png", width: 48, height: 48 },
    ],
  },
];
